...
//Metodo main para crear la clase IniciarSesion
...
//clase IniciaSesion para poder crearla sin  estado 
...
Future<List> _login() async {
  ...
  if(datauser.length==0){
    setState(() {
          mensaje ="'usuario o contraseña errada";
        });
  }else{
...
//Metodo build para crear los campos de autenticar
    ...
    builder: (context){
      ...
      body: Center(child: FutureBuilder<persona>( builder :(context,snapchot){
        ...
        return Text(snapchot.data.usuario);
          ...
          return Text('usuario o contraseña errada');
        }
